#!/usr/bin/env python3
"""
Script to check for method presence directly in the file content of the restored API client.
"""
import os
import re
...
def check_methods_in_file():
    ...
    required_methods = [
        ...
        "get_stats",
        "create_sale",
        "_generate_dummy_stats",
        "_generate_dummy_orders",
        "_generate_dummy_expenses",
        "_generate_dummy_categories",
        "_generate_dummy_sale_response"
    ]
